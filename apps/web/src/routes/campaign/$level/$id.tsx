        ...
        <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center gap-6 p-5">
            <div className="flex h-full flex-1 flex-col items-center justify-center">
                <GameState
                    ...
                    onNext={handleNext}
                    headerInfo={
                        <span className="font-bold text-green-800 text-xs uppercase">
                            CAMPAIGN MODE
                        </span>
                    }
                />
            </div>
            <div className="relative flex flex-1 flex-col border-green-900 border-r bg-black/50 p-8">
                ...
                <div className="relative z-10 flex h-full flex-col">
                    <div className="mb-8 border-green-900 border-b pb-4">
                    ...
                    <div className="flex-1 overflow-y-auto pr-4">
                        <div className="whitespace-pre-wrap border border-green-800 bg-green-900/10 p-6 font-medium text-green-400 text-sm leading-7">
                            {data.briefing}
                        </div>
                    </div>
                </div>
